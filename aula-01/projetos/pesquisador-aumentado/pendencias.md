...
- [ ] **Status:** Aberto
- **O quê decidir:** o offerbook lista headline de identidade ("Você passou anos aprendendo a fazer perguntas certas...") e headline de contraste B2C ("Há um curso que ensina o aluno a parecer produtivo..."). O `copy.md` selecionou a de contraste (D2) como #1 do banco de 5, mas isso não substitui a decisão final do dono.
